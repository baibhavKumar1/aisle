...
const CATEGORIES = ['Catering', 'Floral', 'Makeup', 'Outfit', 'Photography', 'Venue'];
          ...
          <div className="flex flex-wrap gap-2">
            {CATEGORIES.map(cat => (
              <button
                ...
                className={`px-2 py-2 brutal-border font-label-bold text-xs uppercase transition-all ${
